...
/** Software SHA-256. Vite workers often have no `crypto.subtle`. */
export function sha256Software(data: Uint8Array): string {
...
function subtleDigest(): SubtleCrypto | undefined {
  const subtle = globalThis.crypto?.subtle;
  if (subtle && typeof subtle.digest === "function") return subtle;
  return undefined;
}
