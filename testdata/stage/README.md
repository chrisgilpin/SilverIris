...
an END-only setup must keep the greyscale G1 hash. Far pads cull. Door-sized bg portals (and the start alcove) with no nearby pad door get a closed G1DL slab that SETTEX-samples the Facility door tile (id 685). Retail P*Z G_VTX is segment 4.
