...
make -C native player-test        # 10 s analog walk tape; |z| shows dt=3; Shift/PORT_RUN is 1.9×
make -C native gun-test           # PP7 mag, stan/door/guard hit+kill, no_assets z=-50
